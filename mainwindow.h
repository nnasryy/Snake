...
private:
    ...
    static const int TICKS_MOVIMIENTO_BLOQUE = 18; // se mueven cada 5 ticks, mas lento que la serpiente
    ...
    QPushButton *btnPausaJuego;
    QPushButton *btnToggleMusica;
    QString rutaIconoPausa;
    QString rutaVolumenPlay, rutaVolumenPause;
    ...
    int metaFrutasNivel;
    int vidasRestantes;
    static const int LONGITUD_MINIMA_SEGURA = 3;
    Comida powerUpJuego;
    QGraphicsPixmapItem *itemPowerUp;
    bool powerUpVisible;
    int contadorPowerUp;
    QString rutaSpritePowerUp;
    int tipoEfectoPowerUp;
    ...
    void iniciarNivel2();
    QGraphicsPixmapItem **segmentosVisuales; // arreglo dinamico de sprites de la serpiente
    ...
    int cantidadVariantesPowerUp = 0;
    static const int INTERVALO_MINIMO_NIVEL2 = 90;
    void iniciarNivel3();
    ...
    void abrirOpciones();
    void actualizarTeclasOpciones();   // pone en gris las teclas que no se estan usando
    static QPixmap pixmapEnGris(const QPixmap &original);

    QWidget *paginaAlbums;
    QWidget *paginaAlbumNivel[3];
    QPushButton *btnAlbumNivel[3];
    void crearPaginaAlbums();
    void crearPaginaAlbumNivel(int nivel);
    void actualizarBotonesAlbums();
